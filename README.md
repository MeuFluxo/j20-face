...
Página estática de Lucas Mallmann, em HTML, CSS e JavaScript. Arquivo principal: `index.html`. Não requer build, framework ou banco de dados.

## Abrir e publicar

Abra `index.html` para visualizar o layout. Para testar o vídeo, sirva esta pasta por HTTP, por exemplo com `python3 -m http.server 4175 --bind 127.0.0.1`.
...
Página original: https://meufluxo.com/pv/lucas-mallmann-jejum-2-0-vsl3-h1/

Embed: `ab-6a1af3926d918afe2b3fbbc0`.

Checkout informado pelo proprietário: https://checkout.payt.com.br/e77716f701452b971d0fc9c4bddcc23d
